...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/page/common/js/webuploader-0.1.5/webuploader.js"></script>
</head>
<body>
	<h1></h1>
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        // swf文件路径
        swf: '${pageContext.request.contextPath}/page/common/js/webuploader-0.1.5/Uploader.swf',

        // 文件接收服务端。
        server: '${pageContext.request.contextPath}/uploadHeadPic/',
